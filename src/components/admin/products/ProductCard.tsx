 ...
 * Categoría y color se leen del objeto devuelto por la API.
 */
      ...
      <div className={styles.body}>
        ...
        <div className={styles.infoRow}>
          ...
          <div className={styles.infoItem}>
            ...
            <span className={styles.infoValue}>{localVentas}</span>
          </div>
        </div>
        ...
        <div className={styles.stockOpsSection}>
          ...
          {error && (
            <p className={styles.movementError} role="alert">{error}</p>
          )}
        </div>
