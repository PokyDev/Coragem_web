    ...
    >
      ...
      <div
        style={{
          ...
          transition:
            "border-color 0.25s ease, box-shadow 0.25s ease, background-color 0.3s ease",
          ...
          <>
            ...
            <div
              style={{
                ...
                borderRadius: "12px",
                boxShadow:
                  "0 8px 24px rgba(15,26,42,0.12), 0 2px 6px rgba(0,0,0,0.06)",
                overflow: "hidden",
      ...
      <style>{`
        .search-wrapper:focus-within {
          border-color: var(--coragem-teal) !important;
