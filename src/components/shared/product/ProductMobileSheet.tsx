  ...
  return (
    <>
      ...
      >
        ...
        {/* ── Zoom | Imagen (fila fija, 50/50) — zoom a la izquierda, imagen a la derecha ── */}
        <div
          style={{
            flexShrink: 0,
            display: "grid",
        ...
        >
          ...
          {/* Imagen original (derecha) — listeners nativos adjuntados via useEffect */}
          <div
